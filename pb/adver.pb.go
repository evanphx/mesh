...
// source: github.com/evanphx/mesh/pb/adver.proto
// DO NOT EDIT!
...
/*
	...
	It is generated from these files:
		github.com/evanphx/mesh/pb/adver.proto
		github.com/evanphx/mesh/pb/header.proto
		github.com/evanphx/mesh/pb/routing.proto
...
type Advertisement struct {
	...
	Owner      github_com_evanphx_mesh.Identity `protobuf:"bytes,2,opt,name=owner,proto3,casttype=github.com/evanphx/mesh.Identity" json:"owner,omitempty"`
	...
	Resources  map[string]string                `protobuf:"bytes,6,rep,name=resources" json:"resources,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
type AdvertisementUpdate struct {
	...
	Origin       github_com_evanphx_mesh.Identity `protobuf:"bytes,3,opt,name=origin,proto3,casttype=github.com/evanphx/mesh.Identity" json:"origin,omitempty"`
}
...
func init() {
	proto.RegisterType((*Advertisement)(nil), "pb.Advertisement")
	proto.RegisterType((*AdvertisementUpdate)(nil), "pb.AdvertisementUpdate")
	proto.RegisterType((*AdvertisementChanges)(nil), "pb.AdvertisementChanges")
	proto.RegisterType((*RetrieveAdverRequest)(nil), "pb.RetrieveAdverRequest")
	proto.RegisterType((*AdvertisementSet)(nil), "pb.AdvertisementSet")
}
...
func (this *AdvertisementUpdate) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&pb.AdvertisementUpdate{")
...
func (this *AdvertisementChanges) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&pb.AdvertisementChanges{")
...
func (this *RetrieveAdverRequest) GoString() string {
	...
	s := make([]string, 0, 4)
	s = append(s, "&pb.RetrieveAdverRequest{")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *AdvertisementSet) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&pb.AdvertisementSet{")
	if this.Advers != nil {
...
func (c *servicesClient) SyncAdvertisements(ctx context.Context, in *AdvertisementUpdate, opts ...grpc.CallOption) (*AdvertisementChanges, error) {
	...
	err := grpc.Invoke(ctx, "/pb.Services/SyncAdvertisements", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *servicesClient) RetrieveAdvertisements(ctx context.Context, in *RetrieveAdverRequest, opts ...grpc.CallOption) (*AdvertisementSet, error) {
	...
	err := grpc.Invoke(ctx, "/pb.Services/RetrieveAdvertisements", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Services_SyncAdvertisements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Services/SyncAdvertisements",
	}
...
func _Services_RetrieveAdvertisements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.Services/RetrieveAdvertisements",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Services_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/evanphx/mesh/pb/adver.proto",
}
...
func (m *Advertisement) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Subsystem) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintAdver(dAtA, i, uint64(len(m.Subsystem)))
	...
	if len(m.Config) > 0 {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintAdver(dAtA, i, uint64(len(m.Config)))
		i += copy(dAtA[i:], m.Config)
	}
	if m.TimeToLive != 0 {
		dAtA[i] = 0x40
		i++
		i = encodeVarintAdver(dAtA, i, uint64(m.TimeToLive))
	}
	if len(m.Signer) > 0 {
		dAtA[i] = 0x4a
		i++
		i = encodeVarintAdver(dAtA, i, uint64(len(m.Signer)))
		i += copy(dAtA[i:], m.Signer)
	}
	if len(m.Signature) > 0 {
		dAtA[i] = 0x52
		i++
		i = encodeVarintAdver(dAtA, i, uint64(len(m.Signature)))
...
func (m *AdvertisementUpdate) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Origin) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintAdver(dAtA, i, uint64(len(m.Origin)))
...
func (m *Advertisement) Size() (n int) {
	...
	if m.TimeToLive != 0 {
		n += 1 + sovAdver(uint64(m.TimeToLive))
	}
	l = len(m.Signer)
	if l > 0 {
		n += 1 + l + sovAdver(uint64(l))
...
func init() { proto.RegisterFile("github.com/evanphx/mesh/pb/adver.proto", fileDescriptorAdver) }

var fileDescriptorAdver = []byte{
	// 582 bytes of a gzipped FileDescriptorProto
	,
}
